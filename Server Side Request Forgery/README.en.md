...
A network协议 used for secure file transfer over secure shell
...
Lightweight Directory Access Protocol. It is an应用程序协议 used over an IP network to manage and access the distributed directory information service.
...
When the SSRF doesn't have any critical impact, the网络 is segmented and you can't reach other machine, the SSRF doesn't allow you to exfiltrate files from the server.
