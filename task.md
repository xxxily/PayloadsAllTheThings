...
> 你是优秀的翻译官，你能准确地将英文文档翻译成中文文档，翻译的过程中能准确还原中文的表达习惯、思考方式和行文特点，而不是生硬的机器翻译。

## 任务说明

- **备份规则**: 所有需要翻译的 `.md` 文件需先备份一份，命名为 `xxx.en.md`
- **翻译规则**: 翻译后的内容直接写入原有 `.md` 文件
- **头部添加**: 在翻译文件的头部添加"原文文档"链接，指向对应的 `xxx.en.md` 备份文件
- **状态标记**: 翻译完成后请在下面的翻译任务清单中打勾，也就是将 `- [] xxx` 改成 `- [x] xxx`
...
### _LEARNING_AND_SOCIALS 目录
- [x] _LEARNING_AND_SOCIALS/BOOKS.md
- [x] _LEARNING_AND_SOCIALS/TWITTER.md
- [x] _LEARNING_AND_SOCIALS/YOUTUBE.md

### _template_vuln 目录
- [x] _template_vuln/README.md

### Account Takeover 目录
- [x] Account Takeover/README.md
- [x] Account Takeover/mfa-bypass.md

### API Key Leaks 目录
- [x] API Key Leaks/README.md
- [x] API Key Leaks/IIS-Machine-Keys.md

### Brute Force Rate Limit 目录
- [x] Brute Force Rate Limit/README.md

### Business Logic Errors 目录
- [x] Business Logic Errors/README.md

### Clickjacking 目录
- [x] Clickjacking/README.md

### Client Side Path Traversal 目录
- [x] Client Side Path Traversal/README.md

### Command Injection 目录
- [x] Command Injection/README.md

### CORS Misconfiguration 目录
- [x] CORS Misconfiguration/README.md

### CRLF Injection 目录
- [x] CRLF Injection/README.md

### Cross-Site Request Forgery 目录
- [x] Cross-Site Request Forgery/README.md

### CSV Injection 目录
- [x] CSV Injection/README.md

### CVE Exploits 目录
- [x] CVE Exploits/README.md
- [x] CVE Exploits/Log4Shell.md

### Denial of Service 目录
- [x] Denial of Service/README.md

### Dependency Confusion 目录
- [x] Dependency Confusion/README.md

### Directory Traversal 目录
- [x] Directory Traversal/README.md

### DNS Rebinding 目录
- [x] DNS Rebinding/README.md

### DOM Clobbering 目录
- [x] DOM Clobbering/README.md

### Encoding Transformations 目录
- [x] Encoding Transformations/README.md

### External Variable Modification 目录
- [x] External Variable Modification/README.md

### File Inclusion 目录
- [x] File Inclusion/README.md
- [x] File Inclusion/LFI-to-RCE.md
- [x] File Inclusion/Wrappers.md

### Google Web Toolkit 目录
- [x] Google Web Toolkit/README.md

### GraphQL Injection 目录
- [x] GraphQL Injection/README.md
...
- [x] Insecure Deserialization/DotNET.md
- [x] Insecure Deserialization/Java.md
- [x] Insecure Deserialization/Node.md
- [x] Insecure Deserialization/PHP.md
- [x] Insecure Deserialization/Python.md
...
1. 每个翻译后的MD文件都需要在文件头部添加以下链接（使用相对路径）：
   ```markdown
   [原文文档](xxx.en.md)
   ```
...
3. 翻译过程中保持Markdown格式不变

4. 完成翻译后在上面对应任务前打勾，也就是将 `- [] xxx` 改成 `- [x] xxx`